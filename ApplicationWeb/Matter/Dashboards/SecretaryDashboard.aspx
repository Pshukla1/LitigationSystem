<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="SecretaryDashboard.aspx.cs" Inherits="Matter_Dashboards_SecretaryDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box round first grid" style="width: 950px; margin-top: 12px">
        <h2>
            <asp:Label ID="lblLawyerDashboard" runat="server" meta:resourcekey="Secretarydashboard"
                Text=""></asp:Label></h2>
        <div id="add-new">
                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td valign="top" colspan="2" class="box round first grid">
                                                <h2>
                                        ...
                                        <tr>
                                            <td style="width: 50%" valign="top" class="box round first grid">
                                                ...
                                                |
                                                <asp:LinkButton ID="lnkhearingPrint" runat="server" meta:resourcekey="PrintList"
                                                    OnClick="lnkhearingPrint_Click"></asp:LinkButton>
                                                <div>
