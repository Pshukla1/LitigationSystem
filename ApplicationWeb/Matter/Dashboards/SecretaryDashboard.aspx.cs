...
//   1			    26.06.13                        Praveen Shukla                                Secretary Dashboard.
...
public partial class Matter_Dashboards_SecretaryDashboard : System.Web.UI.Page
{
    #region   ********  Public Declaration *************************
    DataTable dt = new DataTable();
    Secretarydashboardlogic LDBL = new Secretarydashboardlogic();
    ...
    private void ExporttoExcel(DataTable table)
    {
        ...
        int columnscount = DtgUpcomingHearings.Columns.Count;
        ...
        {      //write in new column
            ...
            HttpContext.Current.Response.Write(DtgUpcomingHearings.Columns[j].HeaderText.ToString());
            HttpContext.Current.Response.Write("</B>");
            HttpContext.Current.Response.Write("</Td>");
        }
    ...
    #endregion
    protected void lnkhearingPrint_Click(object sender, EventArgs e)
    {
        //dt = LDBL.GetupcomingHearings_English(EMP_ID);
        //ExporttoExcel(dt);
    }
